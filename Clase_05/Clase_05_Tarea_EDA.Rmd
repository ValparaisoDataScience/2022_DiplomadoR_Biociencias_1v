...
**c)** Realice ahora una gráfica de interacción y una gráfica de tamaño de los efectos de la variable *weight* usando las funciones **interaction.plot()** y **plot.design()**. Incluya *feed* y *sex* como factores.
