---
title: "Clase 22 - Análisis de sobrevivencia"
...
# ESTUDIO DE CASO: EFICACIA VACUNAS SALMÓN.

- Coinfección por parásitos reduce la eficacia.
```{r, out.width='90%'}
knitr::include_graphics("Caligus.png")
```

[Figueroa et al. 2017](https://www.nature.com/articles/s41598-017-18180-6)
...
- Guía de trabajo práctico disponible en realiza en Posit.cloud.  
