---
title: "Clase 08 - Guía de trabajo Rmarkdown y archivos .RData y .rds"
...
### **Ejercicio 11.** **Guarde archivo .rds**

Guarde el objeto BOD como un objeto .rds. Use la función **saveRDS()**

```{r, echo=TRUE}
saveRDS(BOD,"BOD.rds" )
```

### **Ejercicio 12.** **Cargar archivo .rds**

Cargar el BOD.rds que guardo en el ejercicio anterior. Use la función **readRDS()**. Nombre el objeto como **datos_BOD**

```{r, echo=TRUE}
datos_BOD <-  readRDS("BOD.rds")
```

### **Ejercicio 13.** **Guarde archivo .RData**

Todos los objetos generados en el espacio de trabajo deben ser guardados como un objeto .RData.
Use la función **save.image()**

```{r, echo=TRUE}
save.image("Guia_R_Markdown.RData")
```

### **Ejercicio 14.** **Cargar archivo .RData**

Cargar el archivo.RData que guardo en el ejercicio anterior. Use la función **load()**

```{r, echo=TRUE}
load("Guia_R_Markdown.RData")
```
