...
En este estudio de caso trabajaremos con un set de datos de arroz (*rice*) del paquete de R **agriTutorial** (n=). 
rice {agriTutorial}
...
**d).** Halle los estimadores puntuales de los promedios y las varianzas de la variable yield para cada nivel del factor management. Incluya tambien el **n** muestral. Use el paquete dplyr y los comandos **group_by()**, **summarise()**.
