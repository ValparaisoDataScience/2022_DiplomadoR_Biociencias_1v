...
El **trabajo** corresponde a un proyecto personal de análisis exploratorio de datos de biociencias con R. El trabajo se puede realizar simulando datos, mediante el uso de datos propios (ej. de su trabajo o empresa), o mediante la recopilación de datos desde cualquier base de datos pública.
